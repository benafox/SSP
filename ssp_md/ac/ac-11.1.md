...
Teachers, school administrators, and system administrators use managed devices that lock after 15 minutes of inactivity, concealing whatever was displayed on the screen, and replacing it with the IPS logo. Parent endpoint devices are not managed by IPS and are protected by AC-12.
