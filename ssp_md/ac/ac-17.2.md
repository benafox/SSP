...
The two cryptographic methods used to encrypt the traffic to the system are SSH for system admins and TLS 1.2+ for parents, teachers, and school administrators.
