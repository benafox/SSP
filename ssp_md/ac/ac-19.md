...
The IPS-SRS-001 system does not authorize organization controlled mobile devices within its authorization boundary. End users may access the web application from a browser, system administrators access via AWS Systems Manager Session Manager, not a mobile device. Remote access is addressed in AC-17, external systems are addressed in AC-20, neither of which contain organization-controlled mobile devices covered in control AC-19.
