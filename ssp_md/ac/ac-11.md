...
x-trestle-set-params:
  ...
  ac-11_odp.01:
    ...
    profile-param-value-origin: AC-11 implementation statement
    ssp-values:
    - initiating a device lock after [time period] of inactivity
  ac-11_odp.02:
...
Parent devices are unmanaged, making a screen lock unenforceable. AC-12 protects these users with a session termination.

IPS staff, including teachers, school administrators, and system administrators use a managed device to enforce an inactivity limit of 15 minutes before locking the device.
